 ...
 *
 * Usage: node servers/build-standalone.mjs <entry> <outName>
 *   e.g. node servers/build-standalone.mjs servers/design-mcp/index.ts design-mcp
 */
...
if (!entry || !outName) {
  console.error("Usage: node servers/build-standalone.mjs <entry> <outName>");
  process.exit(1);
}
